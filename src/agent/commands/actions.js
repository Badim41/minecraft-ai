...
export const actionsList = [
    ...
    },
    {
        ...
        params: {
            // FORKED
            'type': { type: 'BlockName', description: 'The block type to collect. If the query is unclear, for example, "collect any flowers", then select the flowers next to it. The same applies if you are asked to "get any blocks, get any block nearby."' },
